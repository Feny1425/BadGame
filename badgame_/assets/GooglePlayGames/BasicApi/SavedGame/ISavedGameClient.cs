...
namespace GooglePlayGames.BasicApi.SavedGame
{
    ...
    public interface ISavedGameClient
    {
        ...
        void ShowSelectSavedGameUI(string v, int maxNumToDisplay, bool allowCreateNew, bool allowDelete, Action<SelectUIStatus, ISavedGameMetadata> onSavedGameSelected);
    }
